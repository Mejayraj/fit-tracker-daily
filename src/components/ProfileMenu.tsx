    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          className="image-outline rounded-full h-12 w-12 shrink-0 bg-secondary text-foreground border-2 border-primary shadow-[0_6px_20px_hsl(var(--primary)/0.35)]"
        >
          <span className="optical-up text-base font-semibold">{initial}</span>
        </Button>
      </DropdownMenuTrigger>
